# ADR-011 — Three-Layer Agent Model
...
**Rejected because:** the founder raised this proactively, the cost of fixing it later (renaming many more documents) is higher than fixing it now, and the new ADR-011 is itself the right place to lock this in.
